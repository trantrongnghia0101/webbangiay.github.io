      ...
      <?php if(isset($products)): ?>
          ...
          <div class="card float-start m-3 shadow-lg border-0" style="width: 15rem;">
            <div class="card-header">
              ...
              <div class="overlay">
                <a href="<?php echo e(route ('addToCart', $item->id)); ?>"><button class="btn btn-primary">Thêm sản phẩm</button></a>
              </div>
            </div>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\wd18313\demo3\resources\views/shop.blade.php ENDPATH**/ ?>